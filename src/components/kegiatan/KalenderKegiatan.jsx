            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <button type="button" onClick={() => setJenisDokumen('TUGAS')} className={`py-3 rounded-xl border-2 font-bold text-sm transition-all flex justify-center items-center ${jenisDokumen === 'TUGAS' ? 'border-purple-500 bg-purple-50 text-purple-700' : 'border-slate-200 text-slate-500 hover:border-slate-300'}`}>
              ...
              <div>
                ...
                {jenisDokumen === 'TUGAS' ? (
                  <div className="bg-purple-50 border border-purple-100 rounded-xl p-3 text-sm font-medium text-purple-700">
                    Sistem akan otomatis mencetak Surat Tugas untuk <strong>semua {daftarNamaPetugas.length} pegawai</strong> sekaligus di dalam 1 dokumen.
                  </div>
                ) : printData.pegawai ? (
              ...
              {(jenisDokumen === 'SPPD' || jenisDokumen === 'TUGAS') && relatedActivities.length > 0 && (
                <div className={`${jenisDokumen === 'SPPD' ? 'bg-emerald-50/50 border-emerald-100' : 'bg-purple-50/50 border-purple-100'} border p-4 rounded-xl mt-4`}>
                  <label className={`block text-sm font-bold ${jenisDokumen === 'SPPD' ? 'text-emerald-800' : 'text-purple-800'} mb-2`}>3. Tambahkan Tujuan Lain (Maks 2 Hari Tambahan)</label>
            ...
            <table className="w-full border-collapse border border-black mb-3" style={{ fontSize: '10pt' }}>
              <tbody>
                ...
                <tr>
                  ...
                  <td colSpan="2" className="border border-black align-top">{printPetugas ? (printPetugas.includes(',') ? printPetugas.split(',')[0].toUpperCase() + ',' + printPetugas.substring(printPetugas.indexOf(',') + 1) : printPetugas.toUpperCase()) : '.......................................'}<br/>{pegawaiCetak?.nip || ''}</td>
                </tr>
                <tr>
